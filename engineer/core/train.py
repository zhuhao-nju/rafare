...
#from engineer.utils.mesh_utils import test_epoch

logger = logging.getLogger('logger.trainer')

def train_epochs(model, optimizer, cfg, args, train_loader, resume_epoch, gallery_id, test_loader = None):
    ...
    for epoch in range(resume_epoch,cfg.num_epoch):
        ...
        for idx,data in enumerate(train_loader):
            ...
            if not cfg.fine_pifu:
                ...
                preds,loss = model(images = img,calibs=calib,points=samples,
                                   labels=labels,crop_imgs = crop_imgs, 
            ...
            # gallery save, work for i/o label but not for sdf
