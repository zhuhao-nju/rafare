    ...
    def _get_infos(self):
        ...
        for root in input_list:
            ...
            try:
                ...
                #assert os.path.exists(uv_mask) # zhuhao commented this
                #assert os.path.exists(uv_normal) # zhuhao commented this
                #assert os.path.exists(uv_render) # zhuhao commented this
                #assert os.path.exists(uv_pos) # zhuhao commented this
                assert os.path.exists(obj)

                if self.normal:
                    assert os.path.exists(render_normal)
            except:
                continue
